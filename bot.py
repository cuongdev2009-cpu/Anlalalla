...
# ===================== CONFIG =====================
BOT_TOKEN = "8715945694:AAEsv5kOk0ZdYFDNRZlO7qTKbdpOEAbEuPg"   # 🔑 Thay token bot của bạn vào đây
DEFAULT_DELAY = 200               # Delay mặc định: 300 giây (5 phút)
# ==================================================

# State toàn cục
active_tasks: dict[str, asyncio.Task] = {}   # url -> Task
delay_seconds: int = DEFAULT_DELAY
ping_stats: dict[str, dict] = {}             # url -> {count, last_ping, status}
